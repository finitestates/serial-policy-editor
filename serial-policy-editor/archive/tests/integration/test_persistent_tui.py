...
from tests.core.runtime_helpers import engine, NoEogBackend
...
def test_cli_error_is_printed_after_terminal_restoration(tmp_path):
    ...
    with create_pipe_input() as pipe:
        ...
        with patch('trajectory_editor.episode_cli.TerminalIO', return_value=io), \
             ...
             patch('trajectory_editor.episode_cli.CoreEpisodeRunner.run', side_effect=RuntimeError('engine failed')), \
