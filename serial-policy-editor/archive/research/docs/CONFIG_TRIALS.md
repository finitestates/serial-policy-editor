...
[CLI options](../../core/src/trajectory_editor/episode_cli.py),
[group controller](../src/trajectory_editor/group_control.py),
[manual group fitter](../src/trajectory_editor/online_learning.py), and
[token preference learner](../src/trajectory_editor/token_preference.py).
