...
def test_production_coordinates_observations_holds_and_rewind(seed, kernel):
    ...
    for boundary in range(5):
        ...
        assert expected.sampling_coordinate == actual.sampling_coordinate == boundary
    ...
    assert observe(reference_backend, reference).sampling_coordinate == production.observe().sampling_coordinate == 2
